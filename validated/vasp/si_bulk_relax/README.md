...
This example demonstrates a validated minimal bulk silicon structural relaxation workflow using VASP.

The example is intended to serve as:
- a canonical onboarding workflow
- a validated reference calculation
- a reusable template for future workflows
...
It is intended as a stable reference workflow rather than a highly optimized production calculation.
